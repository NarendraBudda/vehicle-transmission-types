...
public class Manual extends Transmission{
    ...
    public Manual(String typeOfTransmission,String modelN0,int noForwardGear,float gearRatio1,float gearRatio2,float gearRatio3,float gearRatio4){
        super(typeOfTransmission, modelN0, noForwardGear, gearRatio1, gearRatio2, gearRatio3, gearRatio4);
    }
    public Manual(String typeOfTransmission,String modelN0,int noForwardGear,float gearRatio1,float gearRatio2,float gearRatio3,float gearRatio4,float gearRatio5){
        super(typeOfTransmission, modelN0, noForwardGear, gearRatio1, gearRatio2, gearRatio3, gearRatio4);
        this.gearRatio5=gearRatio5;
    }
